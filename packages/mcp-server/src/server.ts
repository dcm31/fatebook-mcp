...
import { ClientOptions } from 'fatebook2';
...
export { ClientOptions } from 'fatebook2';
...
export function initMcpServer(params: {
  ...
  const client = new Fatebook2(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Fatebook2({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
